...
# ── Mapping from TXT names -> dashboard names ────────────────────────────────
# scheme_name_map = {
...
# ── Base FUNDS; units overwritten dynamically from TXT ───────────────────────
# FUNDS = {
...
def load_units_from_txt(path="scheme_balance.txt"):
    ...
    # Reverse index: dashboard name -> scheme codes
    name_to_codes = {}
...
def build_snapshot():
    # Refresh units from txt at start of snapshot
